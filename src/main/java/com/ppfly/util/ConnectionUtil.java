...
import com.ppfly.factory.DriverFactory;

import java.sql.*;

public class ConnectionUtil {

	public static String dbUrl = "jdbc:mysql://localhost:3306/test?characterEncoding=utf-8&serverTimezone=UTC";
	...
	public Connection getConn() {
	  ...
	  *
	  * @param
	  * @author Created on 2019/5/13 20:02
	  */
	public static String getMetaDataSql(){
	  ...
	  *
	  * @param
	  * @author Created on 2019/5/13 20:01
	  */
